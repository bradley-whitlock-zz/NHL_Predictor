...
def scrape_data(data, year=2018, num_years=10):
	...
	for curr_year in years:
		...
		page = requests.get("https://www.hockey-reference.com/leagues/NHL_{}_{}.html".format(curr_year, url_field))

		content = BeautifulSoup(page.content, 'html.parser')

		if data == "player":
			get_player_data(content, "players/player_data_{}.csv".format(curr_year))
		else:
			get_game_data(content, "games/game_data_{}.csv".format(curr_year))
